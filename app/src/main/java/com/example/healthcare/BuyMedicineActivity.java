...
public class BuyMedicineActivity extends AppCompatActivity {
    ...
    private String[] package_details={
            ...
            "Provides relief from vitamin B deficiencies\n"+
                    "Helps in fromation of red blood cells\n"+
                    "Maintains healthy nervous system",
            "It promotes health as well as skin benefit.\n"+
                    "It helps in skin blemish and pigmentation.\n"+
                    "It act as safeguard the skin from the harsh UVA and UVb sun rays.",
            "Dolo 650 Tablet helps relieve pain and fever by blocking the release of certain chemical messengers responsible for fever abd pain.",
            ...
            "Helps to rduce the iron deficiency due to chronic blood loss or low intake of iron"
    };
